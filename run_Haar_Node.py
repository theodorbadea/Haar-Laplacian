...
log_path = './tmp/res/Node_Haar_' + dataset_name
...
L = utils.compute_scaled_normalized_Haar_laplacian(f_node, e_node, size, edge_weight=dataset.edge_weight)
